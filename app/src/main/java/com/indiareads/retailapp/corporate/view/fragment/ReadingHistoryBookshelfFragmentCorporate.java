...
public class ReadingHistoryBookshelfFragmentCorporate extends android.support.v4.app.Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_reading_history_bookshelf_corporate, container, false);
        showLoadingScreen();
        fetchBooks();
    ...
    public void fetchBookFromStorage(){
        fetchBooksFromRemoteServer(UrlsCorporate.BOOKSHELF_READING_HISTORY_BOOKS);
    }
    ...
    private void fetchBooksFromRemoteServer(String urls) {
        ...
        try {
            ...
            jsonObjectRequest.setTag(UrlsCorporate.BOOKSHELF_READING_HISTORY_BOOKS_VOLLEY_REQUEST_TAG);
    ...
    private void createRecycleListView(int recyclerViewResource) {
        ...
        bookListAdapter = new WishListBookshelfListAdapterCorporate(getActivity(), bookList,true);
