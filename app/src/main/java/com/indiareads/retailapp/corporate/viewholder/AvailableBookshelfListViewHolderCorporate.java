 ...
 */
public class AvailableBookshelfListViewHolderCorporate extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public AvailableBookshelfListViewHolderCorporate(View itemView, AvailableBookshelfClickListener clickListener) {
        super(itemView);
