...
public class ReturnBookAddAddressFragmentCorporate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_return_book_add_address_corporate, container, false);
    ...
    public void startNextActivity(){
        ...
        Intent intent;
        intent = new Intent(getActivity(), ChoosePickUpAddressActivityCorporate.class);
