...
import com.indiareads.retailapp.corporate.view.activity.AddressBookAddAddressActivityCorporate;
...
public class AddressBookFragmentCorporate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_address_book_corporate, container, false);
...
//        fragmentRootView.findViewById(R.id.address_book_complete_layout).setVisibility(View.GONE);
    ...
    private void setAddAddressClickListener() {
        fragmentRootView.findViewById(R.id.add_new_address).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getActivity(), AddressBookAddAddressActivityCorporate.class);
    ...
    public void fetchAddressFromStorage(){
        fetchAddressesFromRemoteServer(UrlsCorporate.USER_ADDRESS + "/" + getUserId());
    }
