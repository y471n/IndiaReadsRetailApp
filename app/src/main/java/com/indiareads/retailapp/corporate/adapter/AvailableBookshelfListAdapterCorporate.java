...
import com.indiareads.retailapp.corporate.viewholder.AvailableBookshelfListViewHolderCorporate;
 ...
 */
public class AvailableBookshelfListAdapterCorporate extends RecyclerView.Adapter<AvailableBookshelfListViewHolderCorporate>{
    ...
    public AvailableBookshelfListAdapterCorporate(Context context, List<Bookshelf> bookItems) {
    ...
    @Override
    public AvailableBookshelfListViewHolderCorporate onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.available_book_list_item_corporate, parent, false);
        AvailableBookshelfListViewHolderCorporate booksListViewHolder = new AvailableBookshelfListViewHolderCorporate(view, clickListener);

        return booksListViewHolder;
    }

    @Override
    public void onBindViewHolder(AvailableBookshelfListViewHolderCorporate booksListViewHolder, int position) {
