...
public class AddAddressFragmentCorporate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_add_address_corporate, container, false);
    ...
    public String getAddAddressUrl() {
        return UrlsCorporate.ADD_ADDRESS;
    }
    ...
    public void startChooseDeliveryAddressActivity(){
        ...
        Intent intent;
        intent = new Intent(getActivity(), ChooseDeliveryAddressActivityCorporate.class);
