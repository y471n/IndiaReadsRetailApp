...
import com.indiareads.retailapp.corporate.view.activity.OrderDetailsActivityCorporate;
...
public class MyOrderFragmentCorporate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_my_order_corporate, container, false);
    ...
    private void sendAnalaytics() {
        ...
        mTracker.setScreenName("MyOrder Corporate");
...
//        fragmentRootView.findViewById(R.id.my_orders_page_complete_layout).setVisibility(View.GONE);
    ...
    public void fetchOrdersFromStorage(){
        fetchOrdersFromRemoteServer(UrlsCorporate.MY_ORDER);
    }
    ...
    private void fetchOrdersFromRemoteServer(String urls) {
        ...
        try {
            ...
            jsonObjectRequest.setTag(UrlsCorporate.MY_ORDER_VOLLEY_REQUEST_TAG);
    ...
    private void createRecycleListView() {
        ...
        myOrderListAdapter.setClickListener(new ClickListener() {
            ...
            public void itemClicked(View view, int position) {
                ...
                Intent intent = new Intent(getActivity(), OrderDetailsActivityCorporate.class);
