...
import com.indiareads.retailapp.views.activities.HowItWorksActivityCorporate;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class NavigationDrawerFragmentCorporate extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_navigation_drawer_corporate, container, false);
    ...
    private void setMakeCallLinearLayout() {
        fragmentRootView.findViewById(R.id.make_call_linearLayout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getActivity(), ContactUsActivityCorporate.class);
                startActivity(i);
            }
        });
    }
    ...
    private void setHowItWorksClickListener() {
        fragmentRootView.findViewById(R.id.how_it_works_linearLayout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getActivity(), HowItWorksActivityCorporate.class);
