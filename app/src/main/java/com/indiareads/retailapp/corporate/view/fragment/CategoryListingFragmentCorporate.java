...
import com.indiareads.retailapp.corporate.adapter.CategoryListingAdapterCorporate;
import com.indiareads.retailapp.corporate.view.activity.FilterPageActivityCorporate;
...
public class CategoryListingFragmentCorporate extends Fragment {

    View fragmentRootView;
    private RecyclerView mRecyclerView;
    private CategoryListingAdapterCorporate bookListAdapter;
    Dialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_category_listing_corporate, container, false);
    ...
    private void setFilterClickListener() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), FilterPageActivityCorporate.class);
...
//            ((TextView)fragmentRootView.findViewById(R.id.category_listing_message)).setText(R.string.no_book_available_in_this_category);
    ...
    private void createRecycleListView(int recyclerViewResource,final List<BookListing> bookList) {
        ...
        bookListAdapter = new CategoryListingAdapterCorporate(getActivity(), bookList);
