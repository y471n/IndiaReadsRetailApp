...
import com.indiareads.retailapp.adapters.CurrentlyReadingBookshelfAdapter;
...
public class CurrentlyReadingBookshelfFragment extends android.support.v4.app.Fragment {
    ...
    private CurrentlyReadingBookshelfAdapter bookListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_currently_reading_bookshelf, container, false);
        ...
        fragmentRootView.findViewById(R.id.return_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedItems.size() > 0) {
                    Intent intent = new Intent(getActivity(), ChoosePickUpAddressActivity.class);
                    Gson gson = new Gson();
    ...
    public void fetchBookFromStorage(){
        ...
        fetchBooksFromRemoteServer(UrlsRetail.BOOKSHELF_CURRENTLY_READING_BOOKS);
    }
    ...
    private void fetchBooksFromRemoteServer(String urls) {
        ...
        try {
            ...
            jsonObjectRequest.setTag(UrlsRetail.BOOKSHELF_CURRENTLY_READING_BOOKS_VOLLEY_REQUEST_TAG);
    ...
    private void createRecycleListView(int recyclerViewResource) {
        ...
        bookListAdapter = new CurrentlyReadingBookshelfAdapter(getActivity(), bookList);
...
//                ImageView addToCartImageView= (ImageView)returnView.findViewById(R.id.return_book_image_view);
