...
public class LoginActivityMenu extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_activity_menu);
...
//                    sendBookDetailsToServerToAddInBookShelf("1", UrlsRetail.ADD_TO_BOOKSHELF_FOR_BUY, book);
                    ...
                    //Log.e("adding book rent ",book.getTitle());
    ...
    private Response.Listener<JSONObject> getAddToBookShelfResponseListener() {
        return new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject fetchedJson = new JSONObject(response.toString());
                    //Log.e("bookshelf",fetchedJson.toString());
