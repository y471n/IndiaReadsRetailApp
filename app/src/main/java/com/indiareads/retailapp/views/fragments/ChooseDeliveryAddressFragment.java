...
public class ChooseDeliveryAddressFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_choose_delivery_address, container, false);
...
//        fragmentRootView.findViewById(R.id.choose_delivery_Address_complete_layout).setVisibility(View.GONE);
    }
    ...
    public void startNextActivity(){
        Intent intent;
        intent = new Intent(getActivity(), SelectPaymentMethodActivity.class);
