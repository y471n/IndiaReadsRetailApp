...
public class ProfilePageFragment  extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView = inflater.inflate(R.layout.fragment_profile_page, container, false);
...
//        fragmentRootView.findViewById(R.id.profile_page_complete_layout).setVisibility(View.GONE);
    ...
    public String getUserProfileUrl() {
        return UrlsRetail.PROFILE_DETAILS;
    }
    ...
    private void fetchUserProfileFromRemoteServer(String url) {
        ...
        try {
            ...
            jsonObjectRequest.setTag(UrlsRetail.PROFILE_DETAILS_VOLLEY_REQUEST_TAG);
    ...
    public void setUserProfileInfo(JSONObject fetchedJson) {
        ...
        try {
            //  Toast.makeText(getActivity(), ""+fetchedJson.toString(), Toast.LENGTH_SHORT).show();
           // Log.e("profile data ",fetchedJson.toString());
    ...
    public String getEditProfileUrl() {
        return UrlsRetail.EDIT_PROFILE;
    }
