...
public class AddAddressFragment extends Fragment {
  ...
  View fragmentRootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_add_address, container, false);
    ...
    public void startChooseDeliveryAddressActivity(){
        ...
        Intent intent;
        intent = new Intent(getActivity(), ChooseDeliveryAddressActivity.class);
...
//    public  void errorInCheckingPinode(){
//        final AlertDialog alertDialog = new AlertDialog.Builder(getActivity()).create();
//        alertDialog.setTitle("Oops something went wrong!");
//        alertDialog.setMessage("Please try Again");
//        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK",
...
//    public void checkPinCodeFromServer(String url){
//        JsonObjectRequest jsonObjectRequest = null;
//        try {
//            jsonObjectRequest = getPinCodeJsonRequest(url);
//            VolleySingleton.getInstance(getActivity()).addToRequestQueue(jsonObjectRequest);
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
...
//
//        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, url,getJsonObject(), getPinCodeResponseListener(), new Response.ErrorListener() {
//            @Override
//            public void onErrorResponse(VolleyError error) {
//                PD.dismiss();
//                Log.e("error from pincode ", error.toString());
//                if(error instanceof NoConnectionError) {
//                    showNoInternetConnectionDialogForPinCodeCheck();
//                }else{
//                    startErrorPageActivity();
//                }
//            }
//        });
//
