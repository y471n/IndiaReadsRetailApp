...
public class WishListBookshelfFragment extends android.support.v4.app.Fragment  {


    private ArrayList<Bookshelf> bookList;
    private RecyclerView mRecyclerView;
    private View fragmentRootView;
    private WishListBookshelfListAdapter bookListAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView=inflater.inflate(R.layout.fragment_wish_list_bookshelf, container, false);
        showLoadingScreen();
//        deletePopUpTask();
        fetchBooks();
...
//        wishListDeletePopUp= (LinearLayout)fragmentRootView.findViewById(R.id.delete_pop_up_linear_layout);
//        wishListDeletePopUp.setVisibility(View.GONE);
...
//    }
    ...
    public void fetchBookFromStorage(){
        fetchBooksFromRemoteServer(UrlsRetail.BOOKSHELF_WISHLIST_BOOKS);
    }
    ...
    private void fetchBooksFromRemoteServer(String urls) {
        ...
        try {
            ...
            jsonObjectRequest.setTag(UrlsRetail.BOOKSHELF_WISHLIST_BOOKS_VOLLEY_REQUEST_TAG);
    ...
    private void createRecycleListView(int recyclerViewResource) {
        ...
        bookListAdapter = new WishListBookshelfListAdapter(getActivity(), bookList);
...
//                deleteItemPosition=position;
    ...
    public void deleteBookFromServer(int pos){
        deleteBookFromRemoteServer(UrlsRetail.DELETE_WISH_LIST_BOOKS,pos);
    }
