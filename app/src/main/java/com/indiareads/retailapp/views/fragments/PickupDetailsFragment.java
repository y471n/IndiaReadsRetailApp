...
public class PickupDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_pickup_details, container, false);
    ...
    private void setTotalRefundAmount() {
        int totalRefundAmount=0;
        for(int i=0;i<bookList.size();i++){
            totalRefundAmount+=Integer.parseInt(bookList.get(i).getRefund_amount());
        }
        ((TextView)fragmentRootView.findViewById(R.id.pickup_details_total_refund_amount)).setText(totalRefundAmount + "");
    }
    ...
    private void createRecycleListView() {
        ...
        pickupDetailsAdapter = new PickupDetailsAdapter(getActivity(), bookList);
    ...
    private void sendReturnDetailsToServer() {
        ...
        showLoadingDialog();
            try {
                jsonObjectRequest = getReturnBookJsonRequest(UrlsRetail.RETURN_BOOKS);
    ...
    private JsonObjectRequest getReturnBookJsonRequest(String url) throws JSONException {
        ...
        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, url,obj, getReturnBookResponseListener(), new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                PD.dismiss();
              //  Log.e("error from add address ", error.toString());
    ...
    private void startReturnSummaryActivity() {
        Intent intent = new Intent(getActivity(), ReturnSummaryActivity.class);
        Gson gson = new Gson();
