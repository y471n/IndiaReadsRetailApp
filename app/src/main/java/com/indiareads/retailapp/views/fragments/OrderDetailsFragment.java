...
public class OrderDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentRootView= inflater.inflate(R.layout.fragment_order_details, container, false);
...
//        fillDetails();
    ...
    public void fetchAddressFromStorage(){
        ...
        fetchAddressFromRemoteServer(UrlsRetail.GET_PARTICULAR_ADDRESS);
    }
    ...
    private void fetchAddressFromRemoteServer(String urls) {
        ...
        try {
            ...
            jsonObjectRequest.setTag(UrlsRetail.GET_PARTICULAR_ADDRESS_VOLLEY_TAG);
        ...
        return new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    //Log.e("address response ", fetchedJson.toString());
    ...
    public void fillOrderDetails(Order order){
        ...
        ((TextView)fragmentRootView.findViewById(R.id.cart_book_item_initial_payable_price_textview)).setText(order.getInit_pay());
        ...
        if(Integer.parseInt(order.getPayment_option())==1) {
            ((TextView) fragmentRootView.findViewById(R.id.order_details_payment_mode)).setText("Cash On Delivery");
        }else if(Integer.parseInt(order.getPayment_option())==2) {
            ((TextView) fragmentRootView.findViewById(R.id.order_details_payment_mode)).setText("Online");
        }else if(Integer.parseInt(order.getPayment_option())==3) {
            ((TextView) fragmentRootView.findViewById(R.id.order_details_payment_mode)).setText("Pay U Money");
        }else if(Integer.parseInt(order.getPayment_option())==4) {
            ((TextView) fragmentRootView.findViewById(R.id.order_details_payment_mode)).setText("Store Credit");
        }
